...
# Лабораторная работа 2: Cреду исполнения программ на языке Pascal
...
- вывод ошибки при обращении к инициализированной переменной/константе
- Арифметические операции
  - "-" вычитание
  - "+" сложение
  - "*" умножение
  -  div mod - не знаю что это
